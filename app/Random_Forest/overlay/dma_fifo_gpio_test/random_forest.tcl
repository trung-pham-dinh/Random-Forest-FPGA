...
0#Enet 0}\
  ...
  # Create instance: test_fifo_gpio_0, and set properties
  set block_name test_fifo_gpio
  set block_cell_name test_fifo_gpio_0
  if { [catch {set test_fifo_gpio_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $test_fifo_gpio_0 eq "" } {
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axis_data_fifo_0/s_axis_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins test_fifo_gpio_0/rst_n]
  connect_bd_net -net test_fifo_gpio_0_debug_ready [get_bd_pins test_fifo_gpio_0/debug_ready] [get_bd_pins xlconcat_0/In2]
  connect_bd_net -net test_fifo_gpio_0_debug_toggle [get_bd_pins test_fifo_gpio_0/debug_toggle] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net test_fifo_gpio_0_fifo_s_axis_tdata [get_bd_pins axis_data_fifo_0/s_axis_tdata] [get_bd_pins test_fifo_gpio_0/fifo_s_axis_tdata]
  connect_bd_net -net test_fifo_gpio_0_fifo_s_axis_tkeep [get_bd_pins axis_data_fifo_0/s_axis_tkeep] [get_bd_pins test_fifo_gpio_0/fifo_s_axis_tkeep]
  connect_bd_net -net test_fifo_gpio_0_fifo_s_axis_tlast [get_bd_pins axis_data_fifo_0/s_axis_tlast] [get_bd_pins test_fifo_gpio_0/fifo_s_axis_tlast]
  connect_bd_net -net test_fifo_gpio_0_fifo_s_axis_tvalid [get_bd_pins axis_data_fifo_0/s_axis_tvalid] [get_bd_pins test_fifo_gpio_0/fifo_s_axis_tvalid]
  ...
  connect_bd_net -net xlslice_0_Dout [get_bd_pins test_fifo_gpio_0/start] [get_bd_pins xlslice_0/Dout]
