...
################################################################
# This is a generated script based on design: dtp_bram_test_bd
#
...
# source dtp_bram_test_bd_script.tcl
...
set design_name dtp_bram_test_bd
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.Byte_Size {8} \
   CONFIG.Coe_File {../../../../../../../coeff/tree_ram_0.coe} \
...
0#Enet 0}\
  ...
  # Create instance: top_dtp_bram_test_0, and set properties
  set block_name top_dtp_bram_test
  set block_cell_name top_dtp_bram_test_0
  if { [catch {set top_dtp_bram_test_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $top_dtp_bram_test_0 eq "" } {
  ...
  set_property -dict [ list \
   CONFIG.READ_LATENCY {1} \
 ] [get_bd_intf_pins /top_dtp_bram_test_0/DTP_BRAM_PORT_0]

  # Create interface connections
  connect_bd_intf_net -intf_net axi_bram_ctrl_0_BRAM_PORTA [get_bd_intf_pins axi_bram_ctrl_0/BRAM_PORTA] [get_bd_intf_pins top_dtp_bram_test_0/DTP_BRAM_PORT_0]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_1/s_axi_aresetn] [get_bd_pins axi_cdma_0/s_axi_lite_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  ...
  assign_bd_address -offset 0xC2000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces axi_cdma_0/Data] [get_bd_addr_segs axi_bram_ctrl_1/S_AXI/Mem0] -force
